...
def load_data(messages_filepath, categories_filepath):
    """
    Extract messages and categories datasets from thier CSV files
...
def clean_data(df):
    ...
    # Convert category values into binary values (0 or 1)
    ...
    # Replace the original 'categories' dataframe with the new `categories` dataframe
...
def save_data(df, database_filename):
    """
    Load the cleaned dataframe to a SqLite database
